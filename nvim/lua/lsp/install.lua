  ...
  vim.ui.input(
    ...
    function (input)
      if input:lower() == "y" then
        -- Start off cloning nvim-lspconfig. I know it is a dumb way of
        -- installing packages but I don't want any packages/plugins manager. I
        -- prefer (so far) to handle every package and configuration myself to
        -- understand everything under the hood. The git-clone command below
        -- acts more as a reminder of what I've installed and how I did it.
