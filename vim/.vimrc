...
" Autorise la passage d'une ligne à l'autre avec les flèches.
set whichwrap=<,>,[,]
...
" Essaye de garder le curseur sur la même colonne.
set nostartofline
...
" Affiche un menu d'auto-complétion dans le mode ':'.
set wildmenu

" Active l'auto-indentation en mode insertion.
set autoindent

" Surligne la rechercher demandée (:/).
set incsearch
" set hlsearch
